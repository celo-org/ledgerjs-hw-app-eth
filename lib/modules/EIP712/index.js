...
const makeRecursiveFieldStructImplem = ({ transport, loadConfig, chainId, erc20SignaturesBlob, types, filters, shouldUseV1Filters, shouldUseDiscardedFields, coinRefsTokensMap, }) => {
    ...
    const recursiveFieldStructImplem = (destructedType_1, data_1, ...args_1) => __awaiter(void 0, [destructedType_1, data_1, ...args_1], void 0, function* (destructedType, data, path = "") {
        ...
        const isCustomType = !utils_2.EIP712_TYPE_PROPERTIES[((_a = typeDescription === null || typeDescription === void 0 ? void 0 : typeDescription.name) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || ""];
        if (Array.isArray(data) && typeof currSize !== "undefined") {
            ...
            for (const [fieldName, fieldValue] of Object.entries(data)) {
                const fieldType = (_b = typesMap[(typeDescription === null || typeDescription === void 0 ? void 0 : typeDescription.name) || ""]) === null || _b === void 0 ? void 0 : _b[fieldName];
                if (fieldType) {
            ...
            case "showField": {
                ...
                if (isTokenAddress && coinRef !== undefined) {
                    ...
                    if (deviceTokenIndex === undefined) {
                        const payload = yield (0, erc20_1.byContractAddressAndChainId)(token, chainId, erc20SignaturesBlob);
                        if (payload) {
 ...
 * @returns {Promise}
 */
const signEIP712Message = (transport_1, path_1, typedMessage_1, ...args_1) => __awaiter(void 0, [transport_1, path_1, typedMessage_1, ...args_1], void 0, function* (transport, path, typedMessage, fullImplem = false, loadConfig) {
    let APDU_FIELDS;
    (function (APDU_FIELDS) {
        APDU_FIELDS[APDU_FIELDS["CLA"] = 224] = "CLA";
    ...
    const { version } = yield (0, utils_2.getAppAndVersion)(transport);
    ...
    const erc20SignaturesBlob = !shouldUseV1Filters
        ? yield (0, erc20_1.findERC20SignaturesInfo)(loadConfig, domain.chainId || 0)
        : undefined;
